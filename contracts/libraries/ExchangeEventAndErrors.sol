...
library ErrorsAndEvents {
    ...
    error UnacceptedScoreToken(address scoreTokenAddress);
    error ScoreTokenAlreadyAccepted(address scoreTokenAddress);
    error UnexistingScoreToken(address scoreTokenAddress);
    ...
    event NewScoreTokenAccepted(address indexed scoreTokenAddress);
    event ScoreTokenNoLongerAccepted(address indexed scoreTokenAddress);
